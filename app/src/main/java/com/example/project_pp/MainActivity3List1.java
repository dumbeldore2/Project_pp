...
public class MainActivity3List1 extends ArrayAdapter<String> {

    Context context;
    String string[];

    public MainActivity3List1(@NonNull Context c, String s[]) {
        super(c,R.layout.main3_list1,R.id.list_view_2,s);
        this.context = c;
        this.string = s;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View row = layoutInflater.inflate(R.layout.main3_list1,parent,false);
